...
if( empty( $_POST['email'] )|| empty( $_POST['password']) || empty( $_POST['nom'])|| empty( $_POST['prenom'])
 || empty( $_POST['tel']) || empty( $_POST['addresse'])|| empty( $_POST['nbmaison'])|| empty( $_POST['gender'])) {
...
die () ;
 ...
 $result=mysqli_query($con,$sql) ;
    ...
    if(!$result)  {  header('refresh:2;url=register.php');
         echo" <center>
...
// write a qwery 
$sql=" insert into user(email,password,nom,prenom,tel,addresse,nbmaison,gender) values('$email','$password','$nom','$prenom','$tel','$addresse','$nbmaison','$gender')" ;
