...
<body>
    ...
    <section class="pieces">
        <h style="font-family:'Courier New', Courier, monospace; font-size: 30px; color: rgb(39, 29, 29); margin:5px;"> <center> <b> PIÈCE</b></center></h>
        ...
        <table> 
            <tr>
                <td>
                    ...
                    <a href="list.php?piece=salon"> <img src="photo\salon.jpg "> 
                    <h1> Tapis de salon</h1></a>
                </td>

                <td>

                    <a href="list.php?piece=chambre"> <img src="photo\chambre1.jpg "> 
                    <h1> Tapis de chambre</h1></a>
                </td>
                <td>

                    <a href="list.php?piece=entree"> <img src="photo\entree.jpg ">
                    <h1> Tapis d' entree</h1> </a>
                </td>
                ...
                <td> <a href="list.php?piece=toilette"> <img src="photo\toilette.jpg "> 
                    <h1> Tapis de toilette</h1></a>
                </td></tr>
                <tr>
                ...
                <td>
                    <a href="list.php?piece=terrasse"> <img src="photo\terrasse.jpg "> 
                    <h1> Tapis de terrasse</h1></a>
                </td>



                <td>
                    <a href="list.php?piece=bureau"> <img src="photo\bureau.jpg "> 
                    <h1> Tapis de bureau</h1></a>
                </td>
                ...
                <td> <a href="list.php?piece=cuisine"> <img src="photo\cuisine.jpg "> 
                    <h1> Tapis de cuisine</h1></a>
                </td>



                <td> <a href="list.php?piece=couloir"> <img src="photo\couloir.jpg "> 
                    <h1> Tapis de couloir</h1></a>
                </td></tr>
                ...
                <td>
                    ...
                    <a href="enfant.php"> <img src="photo\enfant1.jpg "> 
                    <h1> Tapis de enfant</h1></a>
                </td>
            </tr> --> 
            ...
            <tr>
                <td>
                    ...
                    <a href="list.php?piece=adolescent"> <img src="photo\ado.webp"> 
                    <h1> Tapis pour adolescent</h1></a>
                </td>

                <td>

                    <a href="list.php?piece=fille"> <img src="photo\fille.webp "> 
                    <h1> Tapis pour fille</h1></a>
                </td>
                <td>

                    <a href="list.php?piece=garcan"> <img src="photo\garcan.jpg "> 
                    <h1>Tapis pour garçons</h1></a>
                </td>

            
                
                <td>
                    <a href="list.php?piece=bebe"> <img src="photo\bebe.jpeg "> 
                    <h1> Tapis pour bébé</h1></a>
                </td>
