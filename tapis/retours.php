...
<body>
    ...
    <section id="retours" style="margin-top: 10px ; padding-top: 10px; ">

        <table style="margin:auto ; text-align: center; padding-top: 10px; ">
            <caption style="margin: 15px;"> <img src="photo\satis.webp" width='65px' hight='65px'> </caption>
            <tr>
                <td>
                    <center> <b>100% SATISFAIT OU REMBOURSÉ</b></center>
                    <i>
                        <center> Vous n'êtes pas satisfait de votre produit ? Vous avez changé d'avis ? N'hésitez pas à
                            nous le
                            retourner, vous disposez d'un délai de rétractation.

                            Vous disposez d'un délai de 30 jours, à compter de la date de réception de votre colis, pour
                            nous
                            notifier le ou les produit(s) qui ne vous conviendrai(en)t pas (au lieu des 14 jours
                            légaux).</center>
                    </i>
                </td>
            </tr>
        ...
        <table style="margin:auto ; text-align: center; padding-top: 10px; ">
            <caption style="margin: 15px;"> <img src="photo\retour.webp" width='70px' hight='70px'> </caption>
            <tr>
                <td>
                    <center> <b>30 JOURS POUR ESSAYER</b></center>
                    <i>
                        <center>
                            Dans un souci permanent de satisfaire sa clientèle, <b> <h style="color: brown;">MaisonDuTapis</h></b> s'engage à reprendre les
                            produits livrés qui ne vous conviendraient pas. Vous avez 30 jours pour changer d'avis, sans
                            vous justifier. Il vous suffit de contacter notre service après-vente pour convenir d'un
                            rendez-vous afin de récupérer le produit que vous désirez nous retourner.
                            Pour le cas d'un retrait depuis l'entrepôt, il vous suffit de nous rapporter le produit qui
                            ne vous plait pas dans ce même délai de 30 jours..</center>
                    </i>
                </td>
            </tr>
        </table>
        ...
        <table style="margin:auto ; text-align: center; padding-top: 10px; ">
            <caption style="margin: 15px;"> <img src="photo\service.webp" width='100px' hight='100px'> </caption>
            <tr>
                <td>
                    ...
                    <i>
                        <center>
                            ...
                            côtés jusqu'à la réception de votre commande.</center>
                    </i>
                </td>
            </tr>
        </table>
    ...
    <section>
        <p style="font-size:xx-large">
            <center>
                À votre souris et bon voyage sur <a href="home.html">MaisonDuTapis.com</a>
            </center>
        </p>
    </section>
