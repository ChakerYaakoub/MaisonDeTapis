...
<body>
    ...
    <section class="register">
        ...
        <form method='POST' action='registeradmin1.php'>
            <fieldset>
                <?php
                if($_GET['admin']==1) { echo"<h> <b style='padding: 20px; font-size:x-large;'>
                    <center> Nouvel administrateur</center>
                </b></h>
               <center> <h>  Ce champ appartient à l'administrateur</h></center>
            <table style='margin: auto;'>
                <tr>
                    <td> <b> administrateur </b></td>
                </tr>";}
                else{echo"<h> <b style='padding: 20px; font-size:x-large;'>
                        <center> Nouvel commerçant</center>
                    </b></h>
                   <center> <h>  Ce champ appartient à l'administrateur</h></center>
                <table style='margin: auto;'>
                    <tr>
                        <td> <b> commerçant </b></td>
                    </tr>";}
                ?>
                    ...
                    <tr>
                        <td><input type='number' name='admin'  id='in'  value="<?php if($_GET['admin']==1){echo"1";} else{echo"2";}?>" hidden readonly></td>
                    </tr>
