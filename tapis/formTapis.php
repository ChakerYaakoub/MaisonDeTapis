...
<body>
    ...
    <section class="pieces">
        <h style="font-family:'Courier New', Courier, monospace; font-size: 30px; color: rgb(39, 29, 29); margin:5px;"> <center> <b>FORME</b></center></h>
        ...
        <table> 
            <tr>
                <td>
                    ...
                    <a href="list.php?form=carre"> <img src="photo\carre.jpg ">
                    <h1> Tapis carré</h1> </a>
                </td>

                <td>

                    <a href="list.php?form=rectangle"> <img src="photo\rectangle.jpg "> 
                    <h1>Tapis rectangulaire</h1></a>
                </td>
                <td>

                    <a href="list.php?form=rond"> <img src="photo\rond.webp "> 
                    <h1> Tapis rond</h1></a>
                </td>



                <td> <a href="list.php?form=ovale"> <img src="photo\oval.webp "> 
                    <h1>Tapis ovale</h1></a>
                </td></tr>
