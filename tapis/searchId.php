...
<body>
    ...
    <section> 
     ...
     echo" <br> <br> <br> <br><h > <center> <b style=' font-size: 35px; color: #3c3c3B; padding:20px; '> RECHERCHER / IdTapis''
     <h  style='color: rgb(194, 82, 82);'> ".$idtapis." </h>''</b></center></h> <br>";
...
// if retutne errer alor on a a syntax error in the query :
 ...
 die () ;}
    ...
    } else{header("location:form.php?IdTapis=".$idtapis."") ;
