...
die () ;
  ...
  // write a qwery 
$sql=" delete from tapis where IdTapis='$IdTapis'" ;
...
// if retutne errer alor on a a syntax error in the query :
   ...
   $traget_file="imagesTapis/".$_GET['IdTapis'].".$ext";
   ...
   echo" <center>
       <b style='padding:30px; margin-top:30px; background-color:red; color:white; font-size:30px;'  >Le produit a été supprimé avec succès </b>
   </center>" ;
       ...
       header("refresh:3 ;url=pieces.php") ;
