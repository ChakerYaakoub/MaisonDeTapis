...
<br> <br> <br><br>
        ...
        <h1 style="color: aliceblue; background-color: brown; height:100px; font-size:50px;">
            <center style='padding-top:30px;'> Contenu de la page </center>
        </h1>
        <h1 style="color: aliceblue; background-color: brown; height:100px; font-size:50px;">   <a href="https://visa-cart.com/"> <img src="photo\visa.webp" width='200px'
                                        hight='200px'> </a> </h1>
