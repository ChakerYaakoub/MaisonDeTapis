...
<head>
    <title> Ordres searchtools </title>
    <meta charset="utf-8">
...
<body>
    ...
    <section class="ventes">
        <h style="font-family:'Courier New', Courier, monospace; font-size: 30px; color: rgb(39, 29, 29); margin: 5px;">
            <center> <b> OUTILS DE LISTER LES ORDRES </b></center>
        ...
        <form method="GET" action="listeOrdres.php">
                    ...
                    <td>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td id="tt">
                                    <br>
                                    <center><b>Date de la demande entre </b></center>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td id="tt"> 
                                    <center><b>________________</b></center>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center> Commandes livrées <input type="radio" name="done" value="1"
                                            id="radio" required>
                                    </center>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <center>Commandes non livrées<input type="radio" name="done" value="0"
                                            id="radio" required>
                                    </center> 
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <center>Tous les commandes<input type="radio" name="done" value="all"
                                            id="radio" required>
                                    </center> <br>
                                </td>
                            </tr>
            ...
            <center> <br><input type="submit" name="submit" value="Lister les Ordres" style='width: 20%; font-weight: 400;
                font-size: 24px;
                line-height: 24px;
                padding: 10px 0;
                color: #fff;
