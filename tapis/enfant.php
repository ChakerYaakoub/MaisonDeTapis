...
<body>
    ...
    <section class="pieces" style="background-image: url(https://cdn.maisonsdumonde.com/medias/global/pattern-1.png);">

        <h style="font-family:'Courier New', Courier, monospace; font-size: 40px; color: rgb(39, 29, 29); margin: 5px;"> <center> <b> TAPIS " <h  style='color: rgb(194, 82, 82);'> ENFANT </h>"</b></center></h>
